...
# Por padrão, toda classe Python herda de object
# Tanto faz escrever ou não essa herança
class Animal(object):
    ...
    def falar(self):
        raise NotImplementedError('A calsse filha precisa impementar este método')
